						...
						<div className='flex p-6 gap-6 pb-8'>
							...
							<div className='flex flex-col justify-end'>
								...
								<div className='flex items-center gap-2 text-sm text-zinc-100'>
									<span className='font-medium text-white'>{currentAlbum?.artist.name}</span>
                      ...
                      `}
											>
												...
												<div className='flex items-center gap-3'>
													<img src={song.image_url} alt={song.title} className='size-10' />
												...
												<div className='flex items-center'>{song.created_at}</div>
