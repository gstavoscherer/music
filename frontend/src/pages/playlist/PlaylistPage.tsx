        ...
        <div className='h-full'>
            <ScrollArea className='h-full rounded-md'>
                        ...
                        <div className='flex p-6 gap-6 pb-8'>
                            <img
                                src={currentPlaylist?.image_url
                                    ? `${IMAGE_URL}${currentPlaylist?.image_url}`
                            ...
                            <div className='flex flex-col justify-end'>
                                ...
                                <div className='flex items-center gap-2 text-sm text-zinc-100'>
                                    <span> {currentPlaylist?.song_count} songs</span>
                                </div>
                            </div>
                        </div>
                ...
                hover:scale-105 transition-all'
                            >
                                {isPlaying && currentPlaylist?.songs.some((song: { id: number | undefined; }) => song.id === currentSong?.id) ? (
                      ...
                      `}
                                            >
                                                ...
                                                <div className='flex items-center gap-3'>
                                                    <img src={`${IMAGE_URL}${song.image_url}`} alt={song.title} className='size-10' />
                                                ...
                                                <div className='flex items-center'>{song.created_at ? formatDate(song.created_at) : "--"}</div>
